...
public final strictfp class CharSequenceSubstitutionTest extends XMLTestCase {
	...
	private static String getAnchorForStringXML() {
		return "<gmd:RS_Identifier xmlns:gmx=\""   + LegacyNamespaces.GMX   + '"' +
	...
	private static String getAnchorXML() {
		return "<gmd:CI_Address xmlns:gmx=\""   + LegacyNamespaces.GMX   + '"' +
				" xmlns:gmd=\""   + Namespaces.GMD   + '"' +
				" xmlns:gco=\""   + LegacyNamespaces.GCO   + '"' +
				" xmlns:xlink=\"" + Namespaces.XLINK + "\">\n" +
				"  <gmd:deliveryPoint>\n" +
	...
	private static String getSensorCodeXML() {
		return "<gmi:MI_Instrument xmlns:gmd=\"" + Namespaces.GMD + '"' +
	...
	private static String getCodeListXML() {
		return "<gmd:MD_DataIdentification xmlns:gmd=\"" + Namespaces.GMD + "\">\n" +
				"  <gmd:purpose>\n" +
	 ...
	 */
	@Test
	@DependsOnMethod("testAnchor19139")
	public void testAnchorForString19139() throws JAXBException {
		final String expected = getAnchorForStringXML();
	...
	/**
	 * @see testAnchorForString19139. This is the ISO 19115-3 version.
	 * @throws JAXBException
	 */
	@Test
	@DependsOnMethod("testAnchor191153")
	public void testAnchorForString191153() throws JAXBException {
		final String expected = ISOTestUtils.from19139(getAnchorForStringXML());

		final Identifier id = (Identifier) XML.unmarshal(expected, Namespaces.ISO_19115_3);
		assertEquals("codespace", "L101", id.getCodeSpace());
		assertEquals("code", "EPSG:4326", id.getCode());
	}
	 ...
	 */
	@Test
	public void testAnchor19139() throws JAXBException {
		final String expected = getAnchorXML();
	...
	/**
	 * @see testAnchor19139. This is the ISO 19115-3 version.
	 * @throws JAXBException
	 */
	@Test
	public void testAnchor191153() throws JAXBException {
		final String expected = ISOTestUtils.from19139(getAnchorXML());

		final Address address = (Address) XML.unmarshal(expected, Namespaces.ISO_19115_3);
		assertEquals("Plouzané", address.getCity().toString());
		assertEquals("France", address.getCountry().toString());
		assertEquals(1, address.getElectronicMailAddresses().size());
		...
		final String actual = XML.marshal(address, Namespaces.ISO_19115_3);
		assertXmlEquals(expected, actual, "xmlns:*");
	}
	 ...
	 */
	@Test
	public void testCodeList19139() throws JAXBException {
		final String expected = getCodeListXML();
	...
	/**
	 * @see testCodeList19139. This is the ISO 19115-3 version.
	 * @throws JAXBException
	 */
	@Test
	public void testCodeList191153() throws JAXBException {
		final String expected = ISOTestUtils.from19139(getCodeListXML());

		final DataIdentification id = (DataIdentification) XML.unmarshal(expected, Namespaces.ISO_19115_3);
		assertEquals("purpose", "Investigation", String.valueOf(id.getPurpose()));
		assertSame("purpose", InitiativeType.INVESTIGATION, Types.forCodeTitle(id.getPurpose()));

		final String actual = XML.marshal(id, Namespaces.ISO_19115_3);
		assertXmlEquals(expected, actual, "xmlns:*");
	}
	 ...
	 */
	@Test
	@DependsOnMethod("testCodeList19139")
	public void testSensorCode19139() throws JAXBException {
		final String expected = getSensorCodeXML();
	...
	/**
	 * @see testSensorCode19139. This is the ISO 19115-3 version.
	 * @throws JAXBException
	 */
	@Test
	@DependsOnMethod("testCodeList191153")
	public void testSensorCode191153() throws JAXBException {
		final String expected = ISOTestUtils.from19139(getSensorCodeXML());
