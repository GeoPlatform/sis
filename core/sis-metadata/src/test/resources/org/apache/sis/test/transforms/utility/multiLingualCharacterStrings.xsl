<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <!-- Added by Image Matters LLC for compatibility with Apache SIS -->
    <!-- <xsl:include href="../mapping/defaults.xsl"/> -->
    ...
    <xsl:template name="writeCodelistElement">
        ...
        <xsl:variable name="codeListLocation" select="'http://standards.iso.org/iso/19115/resources/Codelist/cat/codelists.xml'"/>
