        ...
        implements QuantitativeAttributeAccuracy
{
     ...
     */
    public DefaultQuantitativeAttributeAccuracy(final QuantitativeAttributeAccuracy object) {
        super(object);
    }
    ...
    public static DefaultQuantitativeAttributeAccuracy castOrCopy(final QuantitativeAttributeAccuracy object) {
        if (object == null || object instanceof DefaultQuantitativeAttributeAccuracy) {
            return (DefaultQuantitativeAttributeAccuracy) object;
        }
        return new DefaultQuantitativeAttributeAccuracy(object);
    }
}
