...
public class DefaultMetadata extends ISOMetadata implements Metadata {
	...
	private Identifier getXmlMetadataIdentifier() {
		return MetadataInfo.is2003() ? null : getMetadataIdentifier();
	}
	...
	private void setXmlMetadataIdentifier(final Identifier newValue) {
		setMetadataIdentifier(newValue);
	}
	...
	private String getXmlFileIdentifier() {
		return MetadataInfo.is2014() ? null : getFileIdentifier();
	}
	...
	private Locale getXmlLanguage() {
		return null;
		//return MetadataInfo.is2014() ? null : getLanguage();
	}
	...
	private Citation getXmlParentMetadata() {
		return MetadataInfo.is2003() ? null : getParentMetadata();
	}
	...
	private String getXmlParentIdentifier() {
		return MetadataInfo.is2014() ? null : getParentIdentifier();
	}
	...
	private final Date getXmlDateStamp() {
		return MetadataInfo.is2014() ? null : getDateStamp();
	}
	...
	private String getXmlMetadataStandardName() {
		return MetadataInfo.is2014() ? null : getMetadataStandardName();
	}
	...
	private void setXmlMetadataStandardName(final String newValue) {
		setMetadataStandardName(newValue);
	}
	...
	private String getXmlMetadataStandardVersion() {
		return MetadataInfo.is2014() ? null : getMetadataStandardVersion();
	}
	...
	private void setXmlMetadataStandardVersion(final String newValue) {
		setMetadataStandardVersion(newValue);
	}
