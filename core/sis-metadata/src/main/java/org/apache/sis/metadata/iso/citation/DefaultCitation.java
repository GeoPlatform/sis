...
public class DefaultCitation extends ISOMetadata implements Citation {
	...
	private InternationalString getXmlCollectiveTitle() {
		return MetadataInfo.is2003() ? getCollectiveTitle() : null;
	}
