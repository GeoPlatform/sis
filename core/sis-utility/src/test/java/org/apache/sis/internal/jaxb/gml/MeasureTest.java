...
public final strictfp class MeasureTest extends TestCase {
    ...
    public void testSetUOM() throws URISyntaxException {
        ...
        assertEquals(Schemas.METADATA_ROOT_19139 + Schemas.UOM_PATH + "#xpointer(//*[@gml:id='m'])", measure.getUOM());
        ...
        assertEquals("urn:ogc:def:uom:EPSG::9102", measure.getUOM());
        measure.asXPointer = true;
        assertEquals(Schemas.METADATA_ROOT_19139 + Schemas.UOM_PATH + "#xpointer(//*[@gml:id='deg'])", measure.getUOM());

        measure.unit = null;
        measure.asXPointer = true;
        measure.setUOM("gmxUom.xml#kg");                        // Not really an existing unit in 'gmxUom'.
        assertEquals(Units.KILOGRAM, measure.unit);
        assertEquals(Schemas.METADATA_ROOT_19139 + Schemas.UOM_PATH + "#xpointer(//*[@gml:id='kg'])", measure.getUOM());
    }
}
